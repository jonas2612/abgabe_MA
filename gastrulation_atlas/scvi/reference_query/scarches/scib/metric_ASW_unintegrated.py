...
scib_metrics = pd.DataFrame(
    data={'dataset': [sys.argv[1]], 'n_genes': [adata.n_vars], 'metric': ['iso_ASW_unintegrated']}
)
scib_metrics['value'] = scib.me.isolated_labels_asw(adata, label_key=label_key, batch_key=condition_key, embed='X_pca')

scib_metrics.to_csv(f'/home/icb/jonas.flor/gastrulation_atlas/scvi/reference_query/scarches/scib/results/{sys.argv[1]}_iso_ASW_unintegrated.csv')
