...
scib_metrics = pd.DataFrame(
    data={'dataset': [sys.argv[1]], 'n_genes': [sys.argv[2]], 'metric': ['iso_ASW_integrated']}
)
scib_metrics['value'] = scib.me.isolated_labels_asw(adata_int, label_key=label_key, batch_key=condition_key, embed='X_emb')

scib_metrics.to_csv(f'/home/icb/jonas.flor/gastrulation_atlas/scvi/reference_query/scarches/scib/results/{sys.argv[1]}_{sys.argv[2]}_iso_ASW_integrated.csv')
