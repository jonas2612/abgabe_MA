...
scib_metrics = pd.DataFrame(
    data={'dataset': [sys.argv[1]], 'n_genes': [sys.argv[2]], 'metric': ['iLISI_integrated']}
)
scib_metrics['value'] = scib.me.ilisi_graph(adata_int, batch_key=condition_key, type_='embed')

scib_metrics.to_csv(f'/home/icb/jonas.flor/gastrulation_atlas/scvi/reference_query/scarches/scib/results/{sys.argv[1]}_{sys.argv[2]}_iLISI_integrated.csv')
