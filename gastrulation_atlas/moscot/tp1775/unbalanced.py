...
adata_time.obs["target_marginals"] -= (1-100)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
adata_time.obs["target_marginals"] -= (1-800)*(adata_time.obs['annotations_moscot']=='B_cells')
adata_time.obs["target_marginals"] -= (1-180)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-500)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-100)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='Endothelium')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-130)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
...
adata_time.obs["target_marginals"] -= (1-500)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-400)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
adata_time.obs["target_marginals"] -= (1-220)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
...
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Mesoderm')
adata_time.obs["target_marginals"] -= (1-70)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
...
adata_time.obs["target_marginals"] -= (1-400)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
adata_time.obs["target_marginals"] -= (1-700)*(adata_time.obs['annotations_moscot']=='Olidendrocytes')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-300)*(adata_time.obs['annotations_moscot']=='T_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1775_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1775/unbalanced_celltransitions'
)