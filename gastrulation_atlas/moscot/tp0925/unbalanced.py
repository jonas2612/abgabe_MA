...
adata_time.obs["source_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
...
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
...
adata_time.obs["target_marginals"] -= (1-250)*(adata_time.obs['annotations_moscot']=='Extraembryonic_visceral_endoderm')
...
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Gut')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp0925_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp0925/unbalanced_celltransitions'
)