...
adata_time.obs["target_marginals"] -= (1-40)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
...
adata_time.obs["target_marginals"] -= (1-7)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-9)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Glands')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Gut')
adata_time.obs["target_marginals"] -= (1-8)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-8)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-14)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Mast_cells')
adata_time.obs["target_marginals"] -= (1-5/2)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
...
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_glia')
...
adata_time.obs["target_marginals"] -= (1-7/8)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1425_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1425/unbalanced_celltransitions'
)