...
adata_time.obs["target_marginals"] -= (1-1)*(adata_time.obs['annotations_moscot']=='Mesoderm')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-4)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
...
adata_time.obs["target_marginals"] -= (1-350)*(adata_time.obs['annotations_moscot']=='Gut')
adata_time.obs["target_marginals"] -= (1-70)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
...
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-16)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
adata_time.obs["target_marginals"] -= (1-100)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-25)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_glia')
adata_time.obs["target_marginals"] -= (1-7)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
adata_time.obs["target_marginals"] -= (1-30)*(adata_time.obs['annotations_moscot']=='Endothelium')
...
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='Glands')
...
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1175_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1175/unbalanced_celltransitions'
)