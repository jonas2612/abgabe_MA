...
adata_time.obs["source_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Mast_cells')
adata_time.obs["source_marginals"] -= (1-100)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
adata_time.obs["source_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["source_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Mesoderm')
...
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-1)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-9/10)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
...
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-90)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
...
adata_time.obs["target_marginals"] -= (1-15)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
adata_time.obs["target_marginals"] -= (1-12)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Notochord')
adata_time.obs["target_marginals"] -= (1-65)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-30)*(adata_time.obs['annotations_moscot']=='Primitive_erythroid')
adata_time.obs["target_marginals"] -= (1-300)*(adata_time.obs['annotations_moscot']=='Glands')
adata_time.obs["target_marginals"] -= (1-125)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-120)*(adata_time.obs['annotations_moscot']=='Gut')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1225_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1225/unbalanced_celltransitions'
)