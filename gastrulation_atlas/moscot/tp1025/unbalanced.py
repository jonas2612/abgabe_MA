...
adata_time.obs["source_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
...
adata_time.obs["target_marginals"] -= (1-60)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
adata_time.obs["target_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Gut')
adata_time.obs["target_marginals"] -= (1-60)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1025_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1025/unbalanced_celltransitions'
)