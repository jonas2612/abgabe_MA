...
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-180)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
adata_time.obs["target_marginals"] -= (1-70)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
adata_time.obs["target_marginals"] -= (1-42)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1050_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1050/unbalanced_celltransitions'
)