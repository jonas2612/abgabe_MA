...
adata_time.obs["source_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["source_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
...
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
...
adata_time.obs["target_marginals"] -= (1-25)*(adata_time.obs['annotations_moscot']=='Gut')
adata_time.obs["target_marginals"] -= (1-400)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
...
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='T_cells')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Notochord')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1100_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1100/unbalanced_celltransitions'
)