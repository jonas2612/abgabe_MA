...
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Endothelium')
adata_time.obs["target_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Mesoderm')
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-1/6)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-3/4)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Primitive_erythroid')
adata_time.obs["target_marginals"] -= (1-40)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
adata_time.obs["target_marginals"] -= (1-25)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
adata_time.obs["target_marginals"] -= (1-400)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp0950_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp0950/unbalanced_celltransitions'
)