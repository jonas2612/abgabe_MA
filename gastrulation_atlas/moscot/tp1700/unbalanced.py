...
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='B_cells')
adata_time.obs["target_marginals"] -= (1-100)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-140)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
...
adata_time.obs["target_marginals"] -= (1-160)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-300)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
...
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='Hepatocytes')
adata_time.obs["target_marginals"] -= (1-250)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
adata_time.obs["target_marginals"] -= (1-350)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-240)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-450)*(adata_time.obs['annotations_moscot']=='Mast_cells')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
adata_time.obs["target_marginals"] -= (1-145)*(adata_time.obs['annotations_moscot']=='Mesoderm')
adata_time.obs["target_marginals"] -= (1-450)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
...
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
adata_time.obs["target_marginals"] -= (1-450)*(adata_time.obs['annotations_moscot']=='Olidendrocytes')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-800)*(adata_time.obs['annotations_moscot']=='T_cells')
adata_time.obs["target_marginals"] -= (1-1000)*(adata_time.obs['annotations_moscot']=='Testis_and_adrenal')
adata_time.obs["target_marginals"] -= (1-150)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1700_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1700/unbalanced_celltransitions'
)