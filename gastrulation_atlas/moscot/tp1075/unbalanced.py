...
adata_time.obs["target_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Notochord')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1075_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1075/unbalanced_celltransitions'
)