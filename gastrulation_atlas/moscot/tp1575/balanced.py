...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1575_balanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1575/balanced_celltransitions'
)