...
adata_time.obs["source_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["source_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
...
adata_time.obs["target_marginals"] -= (1-1)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1000_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1000/unbalanced_celltransitions'
)