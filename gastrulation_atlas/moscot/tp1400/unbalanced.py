...
adata_time.obs["target_marginals"] -= (1-90)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
adata_time.obs["target_marginals"] -= (1-100)*(adata_time.obs['annotations_moscot']=='B_cells')
adata_time.obs["target_marginals"] -= (1-5/6)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
...
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Glands')
adata_time.obs["target_marginals"] -= (1-35)*(adata_time.obs['annotations_moscot']=='Gut')
...
adata_time.obs["target_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Mesoderm')
adata_time.obs["target_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_glia')
...
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Primitive_erythroid')
adata_time.obs["target_marginals"] -= (1-80)*(adata_time.obs['annotations_moscot']=='T_cells')
adata_time.obs["target_marginals"] -= (1-60)*(adata_time.obs['annotations_moscot']=='Testis_and_adrenal')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1400_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1400/unbalanced_celltransitions'
)