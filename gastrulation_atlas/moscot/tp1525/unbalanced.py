...
adata_time.obs["target_marginals"] -= (1-8)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='B_cells')
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
...
adata_time.obs["target_marginals"] -= (1-8)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
...
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Mast_cells')
...
adata_time.obs["target_marginals"] -= (1-4)*(adata_time.obs['annotations_moscot']=='Olidendrocytes')
...
adata_time.obs["target_marginals"] -= (1-35)*(adata_time.obs['annotations_moscot']=='Testis_and_adrenal')
adata_time.obs["target_marginals"] -= (1-2/3)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1525_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1525/unbalanced_celltransitions'
)