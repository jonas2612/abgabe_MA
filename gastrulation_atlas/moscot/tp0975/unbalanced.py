...
adata_time.obs["source_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
...
adata_time.obs["target_marginals"] -= (1-1/4)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
...
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Primitive_erythroid')
adata_time.obs["target_marginals"] -= (1-1/2)*(adata_time.obs['annotations_moscot']=='Gut')
adata_time.obs["target_marginals"] -= (1-80)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
...
adata_time.obs["target_marginals"] -= (1-80)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp0975_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp0975/unbalanced_celltransitions'
)