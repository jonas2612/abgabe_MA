...
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
...
adata_time.obs["target_marginals"] -= (1-300)*(adata_time.obs['annotations_moscot']=='Notochord')
adata_time.obs["target_marginals"] -= (1-1)*(adata_time.obs['annotations_moscot']=='Primitive_erythroid')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1125_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1125/unbalanced_celltransitions'
)