...
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='B_cells')
adata_time.obs["target_marginals"] -= (1-7/8)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-7/8)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Endothelium')
adata_time.obs["target_marginals"] -= (1-4)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
adata_time.obs["target_marginals"] -= (1-35)*(adata_time.obs['annotations_moscot']=='Glands')
adata_time.obs["target_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Gut')
...
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-14)*(adata_time.obs['annotations_moscot']=='Mast_cells')
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
adata_time.obs["target_marginals"] -= (1-9/10)*(adata_time.obs['annotations_moscot']=='Mesoderm')
adata_time.obs["target_marginals"] -= (1-3/2)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-15)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_glia')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
...
adata_time.obs["target_marginals"] -= (1-7)*(adata_time.obs['annotations_moscot']=='Olidendrocytes')
adata_time.obs["target_marginals"] -= (1-200)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-35)*(adata_time.obs['annotations_moscot']=='T_cells')
adata_time.obs["target_marginals"] -= (1-40)*(adata_time.obs['annotations_moscot']=='Testis_and_adrenal')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1600_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1600/unbalanced_celltransitions'
)