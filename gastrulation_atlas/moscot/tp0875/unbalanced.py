...
adata_time.obs["source_marginals"] -= (1-3/4)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] = np.ones(adata_time.n_obs)
adata_time.obs["target_marginals"] -= (1-1/6)*(adata_time.obs['annotations_moscot']=='Mesoderm')
...
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Endothelium')
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
...
adata_time.obs["target_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Hepatocytes')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp0875_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp0875/unbalanced_celltransitions'
)