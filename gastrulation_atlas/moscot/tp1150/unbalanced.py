...
adata_time.obs["source_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Mesoderm')
...
adata_time.obs["target_marginals"] -= (1-1/5)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-2/3)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
adata_time.obs["target_marginals"] -= (1-1/5)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
adata_time.obs["target_marginals"] -= (1-2/7)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-1/3)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
...
adata_time.obs["target_marginals"] -= (1-60)*(adata_time.obs['annotations_moscot']=='Eye_and_other')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-10)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
adata_time.obs["target_marginals"] -= (1-70)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-15)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
adata_time.obs["target_marginals"] -= (1-5/8)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-3/4)*(adata_time.obs['annotations_moscot']=='Primitive_erythroid')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1150_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1150/unbalanced_celltransitions'
)