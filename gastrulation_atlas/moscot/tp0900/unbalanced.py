...
adata_time.obs["target_marginals"] -= (1-1/5)*(adata_time.obs['annotations_moscot']=='Mesoderm')
...
adata_time.obs["target_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Primordial_germ_cells')
adata_time.obs["target_marginals"] -= (1-30)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-60)*(adata_time.obs['annotations_moscot']=='Extraembryonic_visceral_endoderm')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp0900_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp0900/unbalanced_celltransitions'
)