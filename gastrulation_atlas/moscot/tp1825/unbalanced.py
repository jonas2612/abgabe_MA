...
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
...
adata_time.obs["target_marginals"] -= (1-70)*(adata_time.obs['annotations_moscot']=='Endothelium')
...
adata_time.obs["target_marginals"] -= (1-35)*(adata_time.obs['annotations_moscot']=='Hepatocytes')
adata_time.obs["target_marginals"] -= (1-80)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-180)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
adata_time.obs["target_marginals"] -= (1-250)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-120)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
...
adata_time.obs["target_marginals"] -= (1-35)*(adata_time.obs['annotations_moscot']=='Muscle_cells')
adata_time.obs["target_marginals"] -= (1-180)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_glia')
adata_time.obs["target_marginals"] -= (1-500)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
adata_time.obs["target_marginals"] -= (1-80)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
adata_time.obs["target_marginals"] -= (1-400)*(adata_time.obs['annotations_moscot']=='Olfactory_sensory_neurons')
...
adata_time.obs["target_marginals"] -= (1-700)*(adata_time.obs['annotations_moscot']=='Testis_and_adrenal')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1825_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1825/unbalanced_celltransitions'
)