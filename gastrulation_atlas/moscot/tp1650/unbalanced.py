...
adata_time.obs["target_marginals"] -= (1-7)*(adata_time.obs['annotations_moscot']=='Aidpocytes')
adata_time.obs["target_marginals"] -= (1-30)*(adata_time.obs['annotations_moscot']=='B_cells')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='CNS_neurons')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Cardiocytes')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Definitive_erythroid')
adata_time.obs["target_marginals"] -= (1-4)*(adata_time.obs['annotations_moscot']=='Endothelium')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Ependymal_cells')
adata_time.obs["target_marginals"] -= (1-4)*(adata_time.obs['annotations_moscot']=='Epithelial_cells')
...
adata_time.obs["target_marginals"] -= (1-30)*(adata_time.obs['annotations_moscot']=='Gut')
adata_time.obs["target_marginals"] -= (1-2)*(adata_time.obs['annotations_moscot']=='Hepatocytes')
adata_time.obs["target_marginals"] -= (1-7)*(adata_time.obs['annotations_moscot']=='Intermediate_mesoderm_and_kidney')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='Intermediate_neuronal_progenitors')
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Intestine')
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Lung_and_airways')
adata_time.obs["target_marginals"] -= (1-20)*(adata_time.obs['annotations_moscot']=='Mast_cells')
adata_time.obs["target_marginals"] -= (1-6)*(adata_time.obs['annotations_moscot']=='Megakaryocytes')
...
adata_time.obs["target_marginals"] -= (1-22)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_glia')
adata_time.obs["target_marginals"] -= (1-4)*(adata_time.obs['annotations_moscot']=='Neural_crest_PNS_neurons')
adata_time.obs["target_marginals"] -= (1-5)*(adata_time.obs['annotations_moscot']=='Neuroectoderm_and_glia')
...
adata_time.obs["target_marginals"] -= (1-30)*(adata_time.obs['annotations_moscot']=='T_cells')
adata_time.obs["target_marginals"] -= (1-50)*(adata_time.obs['annotations_moscot']=='Testis_and_adrenal')
adata_time.obs["target_marginals"] -= (1-3)*(adata_time.obs['annotations_moscot']=='White_blood_cells')
...
res.to_csv('/home/icb/jonas.flor/gastrulation_atlas/moscot/data/tp1650_unbalanced.csv')
...
mtp.cell_transition(
    ...
    figsize=(5, 5),
    key="tp_transitions",
    save='/home/icb/jonas.flor/gastrulation_atlas/moscot/tp1650/unbalanced_celltransitions'
)
