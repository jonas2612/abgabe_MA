...
#SBATCH -t 02:00:00 # format dd-hh:mm:ss
...
python -u /home/icb/jonas.flor/gastrulation_atlas/data/atlas_pca.py > atlas_pca.out

path="$(grep -i -E 'error|killed' /home/icb/jonas.flor/gastrulation_atlas/data/bash_messages/errors_atlas_pca)"
if [ -z "$path" ]
then
    sbatch /home/icb/jonas.flor/gastrulation_atlas/data/atlas_neighbors.cmd
else
    echo "Error produced"
fi
